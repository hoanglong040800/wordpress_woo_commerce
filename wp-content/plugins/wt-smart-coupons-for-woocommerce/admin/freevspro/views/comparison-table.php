...
$supported_coupon_types_arr=array(
		__('Give away coupons', 'wt-smart-coupons-for-woocommerce'),
		__('URL coupons', 'wt-smart-coupons-for-woocommerce'),
	);
$pro_only_coupon_types_arr=array(
		__('Give away (multiple products)', 'wt-smart-coupons-for-woocommerce'),
		__('URL coupons', 'wt-smart-coupons-for-woocommerce'),
		__('QR code coupons', 'wt-smart-coupons-for-woocommerce'),
		__('Purchase history-based coupons', 'wt-smart-coupons-for-woocommerce'),
		__('Store credit/Gift coupons', 'wt-smart-coupons-for-woocommerce'),
...
//remove 'Give away coupons' in basic, because pro supports multiple products
unset($supported_coupon_types_arr[0]);
...
$comparison_data=array(
	...
	array(
		__("Allows users to view applicable coupons from the 'My Account' page", 'wt-smart-coupons-for-woocommerce'),
		true,
		true,
	),
	array(
	...
	array(
		__("URL coupon's add-on", 'wt-smart-coupons-for-woocommerce'),
		false,
		true,
	),
	array(
...
<table class="wt_smcpn_freevs_pro">
	<tr>
		<td style="width:250px;"><?php _e('FEATURES', 'wt-smart-coupons-for-woocommerce'); ?></td>
