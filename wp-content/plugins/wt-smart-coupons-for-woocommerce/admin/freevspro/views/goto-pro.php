...
.nav-tab-active{ background:#fff; margin-bottom: -2px; width:80px; }
.nav-tab-active:after{ content: ''; background:#fff; width:100px; height:10px; display:block; z-index:10; position:absolute; margin-left:-10px; margin-top:-3px; }
